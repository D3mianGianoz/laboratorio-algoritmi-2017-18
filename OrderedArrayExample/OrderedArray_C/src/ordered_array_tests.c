...
/*
 * File:   ordered_array_tests.c
 * Author: magro
 *
 * Created on 4 marzo 2017, 15.38
 */
...
void setUp(void){ //Eseguita all'inzio di ogni singolo test
  i1 = -12;
  i2 = 0;
  i3 = 4;
...
void tearDown(void){ //Eseguita alla fine di ogni singolo test
...
static void test_ordered_array_array_three_el(void){
...
int main(void) {
  ...
  RUN_TEST(test_ordered_array_array_three_el);
