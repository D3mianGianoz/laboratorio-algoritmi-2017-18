...
1) posizionarsi in .../OrderedArray_Java/src
2) javac -d ../classes -cp '.;../junit-4.12.jar;../hamcrest-core-1.3.jar' orderedarray/*.java (ATTENZIONE: nelle macchine Windows dei laboratori, i classpath devono essere separati da ";" come in Windows, non da ":" come in Unix, inoltre, occorre mettere l'elenco dei classpath fra apici semplici!)
...
---PER ESEGUIRE orderedarray/OrderedArrayJava_TestsRunner---
1) posizionarsi in .../OrderedArray_Java/classes 
2) java -cp '.;../junit-4.12.jar;../hamcrest-core-1.3.jar'  orderedarray/OrderedArrayJava_TestsRunner
